...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(ClientPrefs.data.checkForUpdates && !closedState) {
			...
			var http = new haxe.Http("https://raw.githubusercontent.com/EggsAndBakey/FNF-VS-Stev-Red-Heaven/main/gitVersion.txt");
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['VS Stev Red Heaven'], 40);
					#else
					createCoolText(['EggsAndBakey']);
					#end
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('The Mod', 40);
					addMoreText('Ever', 40);
					#else
					addMoreText('yea');
					#end
				...
				case 15:
					addMoreText('Red');
				case 16:
					addMoreText('Heaven'); // credTextShit.text += '\nFunkin';
