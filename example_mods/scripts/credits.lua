...
local songData = { -- The main table that contains the songs you want credits on
    ...
    ['hello'] = { -- This name NEEDS to be the name in the direct JSON/chart (e.g: dad-battle).
        ["songName"] = "Hello", -- The display name of the song.
        ...
        -- IF YOU WANT ME TO MAKE IT TO BE IN ORDER, LEAVE A COMMENT ON THE GAMEBANANA PAGE AND I'LL DO IT!
            ["Composer"] = "YAFNFP (Original) EggsAndBakey (Remix)",
            ["Artist"] = "YAFNFP (BG) and EggsAndBakey (Stev)",
            ["Charter"] = "EggsAndBakey",
        },
    },

    ['i-can-has-diamonds'] = { 
        ["songName"] = "I Can Has Diamonds", 
        ["length"] = 3, 
        ["boxColor"] = "#000000", 
        ["textColor"] = "#FFFFFF", 
        ["credits"] = { 
    ...
    ['beacon'] = { 
        ...
        ["credits"] = { 
            ["Composer"] = "EggsAndBakey",
            ["Artist"] = "YAFNFP (OG BG) and EggsAndBakey (Stev + Edited BG)",
            ["Charter"] = "EggsAndBakey",
        },
    },
